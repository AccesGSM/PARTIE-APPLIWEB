...
function getUtilisateurByMailU($mailU) {
    ...
    try {
        $cnx = connexionPDO();
        $req = $cnx->prepare("SELECT * FROM gestion WHERE gestion.mailU = :mailU");
...
function addUtilisateur($mailU, $mdpU, $pseudoU, $admin) {
    try {
        ...
        $req = $cnx->prepare("insert into gestion (mailU, mdpU, pseudoU, admin) values(:mailU,:mdpU,:pseudoU,:admin)");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
...
function enrollUtilisateur($mailU, $mdpU, $pseudoU) {
    try {
        ...
        $mdpUCrypt = password_hash($mdpU, PASSWORD_DEFAULT, ['cost' => 12]);
        $req = $cnx->prepare("insert into gestion (mailU, mdpU, pseudoU) values(:mailU,:mdpU,:pseudoU)");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
        $req->bindValue(':mdpU', $mdpUCrypt, PDO::PARAM_STR);
        $req->bindValue(':pseudoU', $pseudoU, PDO::PARAM_STR);
...
function delUtilisateurByMailU($mailU)
{
    ...
    try {
        ...
        $req = $cnx->prepare("delete from gestion  where mailU=:mailU");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
...
function updtUtilisateur($mailU, $mdpU, $pseudoU, $admin) {
    ...
    try {
        ...
        $mdpUCrypt = password_hash($mdpU, PASSWORD_DEFAULT, ['cost' => 12]);
        $req = $cnx->prepare("update gestion set mailU=:mailU, mdpU=:mdpU, pseudoU=:pseudoU, admin=:admin WHERE mailU=:mailU");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
        $req->bindValue(':mdpU', $mdpUCrypt, PDO::PARAM_STR);
        $req->bindValue(':pseudoU', $pseudoU, PDO::PARAM_STR);
        $req->bindValue(':admin', $admin, PDO::PARAM_STR);
...
function updtAdminUtilisateur($admin, $mailU) {
    ...
    try {
        ...
        $req = $cnx->prepare("update gestion set admin=:admin WHERE mailU=:mailU");
        $req->bindValue(':admin', $admin, PDO::PARAM_STR);
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
...
function updtMailUtilisateur($mailU, $pseudoU) {
    ...
    try {
        ...
        $req = $cnx->prepare("update gestion set mailU=:mailU WHERE pseudoU=:pseudoU");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
        $req->bindValue(':pseudoU', $pseudoU, PDO::PARAM_STR);
...
function updtMdpUtilisateur($mailU, $mdpU) {
    ...
    try {
        ...
        $mdpUCrypt = password_hash($mdpU, PASSWORD_DEFAULT, ['cost' => 12]);
        $req = $cnx->prepare("update gestion set mdpU=:mdpU where mailU=:mailU");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
        $req->bindValue(':mdpU', $mdpUCrypt, PDO::PARAM_STR);
...
function updtPseudoUtilisateur($mailU, $pseudoU) {
    ...
    try {
        ...
        $req = $cnx->prepare("update gestion set pseudoU=:pseudoU where mailU=:mailU");
        $req->bindValue(':mailU', $mailU, PDO::PARAM_STR);
        $req->bindValue(':pseudoU', $pseudoU, PDO::PARAM_STR);
